...
export class TestListComponent implements OnInit {
  ...
  mockTests = [
    {testName: 'MOCK TEST 1', testDesc: 'Real estate is a complex industry, often mired by low standards and greed. Many agents are poorly trained and lack an in-depth understanding of the intricacies of sales, business, and negotiation. Much of the established realty thinking and the accepted strategies are outdated, deceptive, or just plain ineffective.'+
