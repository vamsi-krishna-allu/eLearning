...
const MORTGAGE_COURSES : Courses[] = [
  {courseName: 'MORTGAGE EXAM', courseDesc: 'The Mortgage Licensing Act requires all licensed Mortgage Originators to pass a written test developed by NMLS. Each Mortgage Originator must take the National test component and a specific test component in order to satisfy the test requirements in Canada.'+
